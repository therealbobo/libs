...
const struct ppm_name_value ioctl_commands[] = {
        {"PPM_IOCTL_DISABLE_DROPPING_MODE", PPM_IOCTL_DISABLE_DROPPING_MODE},
        {"PPM_IOCTL_ENABLE_DROPPING_MODE", PPM_IOCTL_ENABLE_DROPPING_MODE},
        {"PPM_IOCTL_SET_SNAPLEN", PPM_IOCTL_SET_SNAPLEN},
        {"PPM_IOCTL_DISABLE_DYNAMIC_SNAPLEN", PPM_IOCTL_DISABLE_DYNAMIC_SNAPLEN},
        {"PPM_IOCTL_ENABLE_DYNAMIC_SNAPLEN", PPM_IOCTL_ENABLE_DYNAMIC_SNAPLEN},
        {"PPM_IOCTL_GET_VTID", PPM_IOCTL_GET_VTID},
        {"PPM_IOCTL_GET_VPID", PPM_IOCTL_GET_VPID},
        {"PPM_IOCTL_GET_CURRENT_TID", PPM_IOCTL_GET_CURRENT_TID},
        {"PPM_IOCTL_GET_CURRENT_PID", PPM_IOCTL_GET_CURRENT_PID},
        {"PPM_IOCTL_GET_PROCLIST", PPM_IOCTL_GET_PROCLIST},
        {"PPM_IOCTL_GET_N_TRACEPOINT_HIT", PPM_IOCTL_GET_N_TRACEPOINT_HIT},
        {"PPM_IOCTL_GET_DRIVER_VERSION", PPM_IOCTL_GET_DRIVER_VERSION},
        {"PPM_IOCTL_SET_FULLCAPTURE_PORT_RANGE", PPM_IOCTL_SET_FULLCAPTURE_PORT_RANGE},
        {"PPM_IOCTL_SET_STATSD_PORT", PPM_IOCTL_SET_STATSD_PORT},
        {"PPM_IOCTL_GET_API_VERSION", PPM_IOCTL_GET_API_VERSION},
        {"PPM_IOCTL_GET_SCHEMA_VERSION", PPM_IOCTL_GET_SCHEMA_VERSION},
        {"PPM_IOCTL_ENABLE_SYSCALL", PPM_IOCTL_ENABLE_SYSCALL},
        {"PPM_IOCTL_DISABLE_SYSCALL", PPM_IOCTL_DISABLE_SYSCALL},
        {"PPM_IOCTL_ENABLE_TP", PPM_IOCTL_ENABLE_TP},
        {"PPM_IOCTL_DISABLE_TP", PPM_IOCTL_DISABLE_TP},
        {"PPM_IOCTL_ENABLE_DROPFAILED", PPM_IOCTL_ENABLE_DROPFAILED},
        {"PPM_IOCTL_DISABLE_DROPFAILED", PPM_IOCTL_DISABLE_DROPFAILED},
        {0, 0},
};
