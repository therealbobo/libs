...
{
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.exe", "First Argument", "The first command line argument argv[0] (usually the executable name or a custom one). This field reflects the first field present in /proc/<pid>/cmdline. Furthermore this field is modified when execve or clone syscall occurs."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.pexe", "Parent First Argument", "The first command line argument argv[0] (usually the executable name or a custom one) of the parent process. This field reflects the first field present in /proc/<pid>/cmdline of the parent process."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.aexe", "Ancestor First Argument", "The first command line argument argv[0] (usually the executable name or a custom one) of one of the process ancestors. e.g. proc.aexe[1] returns the parent first argument, proc.aexe[2] returns the grandparent first argument, and so on. proc.aexe[0] is the first argument of the current process. proc.aexe without arguments can be used in filters only and matches any of the process ancestors, e.g. proc.aexe endswith java."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.exepath", "Process Executable Path", "The full executable path of the process. This is the path of the resolved /proc/<pid>/exe symlink."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.pexepath", "Parent Process Executable Path", "The full executable path of the parent process. This is the path of the resolved /proc/<pid>/exe symlink of the parent process."},
	...
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.name", "Name", "The name (excluding the path) of the executable generating the event usually truncated after 15 characters (depends on the kernel configuration). The value of this field reflects task->comm in the kernel. Furthermore the value is taken from /proc/<pid>/status and modified when an execve or clone syscall occurs."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.pname", "Parent Name", "The name (excluding the path) of the parent of the process generating the event usually truncated after 15 characters (depends on the kernel configuration). The value of this field reflects task->comm in the kernel. Furthermore the value is taken from /proc/<pid>/status and modified when an execve or clone syscall occurs."},
	...
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.args", "Arguments", "The arguments passed on the command line when starting the process generating the event excluding argv[0]. This field is updated when execve or clone syscall occurs."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.cmdline", "Command Line", "The full command line (proc.name + proc.args) when starting the process generating the event (space separated)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.pcmdline", "Parent Command Line", "The full command line (proc.name + proc.args) of the parent of the process generating the event (space separated)."},
	...
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.exeline", "Executable Command Line", "The full command line, with exe as first argument (proc.exe + proc.args) when starting the process generating the event. The content of thi field correspond to /proc/<pid>/cmdline"},
