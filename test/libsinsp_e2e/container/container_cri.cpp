...
{
	fake_cri_test(
		LIBSINSP_TEST_RESOURCES_PATH "/fake_cri_agent",
	    "containerd",
                                         ...
                                         int64_t test_duration)
{
	...
	subprocess fake_docker_handle("/usr/bin/env",
	    {"python", LIBSINSP_TEST_RESOURCES_PATH "/fake_docker.py", std::to_string(docker_delay), fake_docker_socket});
...
TEST_F(container_cri, fake_cri_then_docker)
{
	...
	fake_cri_test_timing(LIBSINSP_TEST_RESOURCES_PATH "/fake_cri_agent",
	                     "--nodelay",
	                     "containerd",
	                     0.5,
	                     true,
...
TEST_F(container_cri, fake_docker_then_cri)
{
	...
	fake_cri_test_timing(LIBSINSP_TEST_RESOURCES_PATH "/fake_cri_agent", "--slow", "containerd", 0.0, true, exp_info);
}
...
TEST_F(container_cri, fake_docker_fail_then_cri)
{
	...
	fake_cri_test_timing(LIBSINSP_TEST_RESOURCES_PATH "/fake_cri_agent", "--slow", "containerd", -0.1, true, exp_info);
}
...
TEST_F(container_cri, fake_docker_then_cri_sync)
{
	...
	fake_cri_test_timing(LIBSINSP_TEST_RESOURCES_PATH "/fake_cri_agent", "--slow", "containerd", 0.0, false, exp_info);
}
...
TEST_F(container_cri, fake_docker_fail_then_cri_sync)
{
	...
	fake_cri_test_timing(LIBSINSP_TEST_RESOURCES_PATH "/fake_cri_agent", "--slow", "containerd", -0.1, false, exp_info);
}
